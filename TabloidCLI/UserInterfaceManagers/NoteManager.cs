...
namespace TabloidCLI.UserInterfaceManagers
{
    internal class NoteManager : IUserInterfaceManager
    {
        ...
        private void Add()
        {
            ...
            note.PostId = _postId;
            Console.WriteLine($"{note.Title} has been added to the notes list.");
        ...
        private void Edit()
        {
            ...
            Console.WriteLine();
            Console.WriteLine("New note title (blank to leave unchanged: ");
            string title = Console.ReadLine();
            if (!string.IsNullOrWhiteSpace(title))
            {
                noteToEdit.Title = title;
            }
            Console.WriteLine("New note content (blank to leave unchanged: ");
