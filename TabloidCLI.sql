...
CREATE TABLE AuthorTag (
    ...
    CONSTRAINT FK_AuthorTag_Tag FOREIGN KEY(TagId) REFERENCES Tag(Id) ON DELETE CASCADE
);
...
CREATE TABLE BlogTag (
    ...
    CONSTRAINT FK_BlogTag_Blog FOREIGN KEY(BlogId) REFERENCES Blog(Id) ON DELETE CASCADE,
    CONSTRAINT FK_BlogTag_Tag FOREIGN KEY(TagId) REFERENCES Tag(Id) ON DELETE CASCADE
);
